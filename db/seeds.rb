...
create_order = Order.create([title: "咖啡公司咖啡杯设计", description: "需要设计一款咖啡杯，体现出简洁优雅的风格", user_id: 2, type_preference: "CONCISE"])
create_order = Order.create([title: "委托设计一系列统计图标", description: "需要有柱状图，饼图，和好看的色彩", user_id: 2, type_preference: "MEDIUM"])
create_order = Order.create([title: "大学圣诞创意作品大奖赛主题演讲幻灯片设计", description: "体现圣诞的气氛，加入欢乐的元素", user_id: 2, type_preference: "GORGEOUS"])
